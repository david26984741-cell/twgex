...
**為什麼美股可以排在台北早上 09:00。** 這裡有兩層，都踩過坑：

CBOE 那份 `delayed_quotes` 檔裡，價格是即時的、未平倉量卻是**隔天早上**才更新
（實測美東 10:00~10:30）。所以開盤前抓 → 價格對但未平倉舊一天；等未平倉更新 → 未平倉對了
但價格變成盤中。**沒有任何一個時點兩者同時正確。** 第一層解法是價格改取每一檔的
`prev_day_close`（前一交易日收盤價），於是只剩「未平倉已更新」一個條件。

第二層是換掉未平倉來源。**OCC 自己就有逐履約價未平倉，而且早 CBOE 十幾個小時**
（`marketdata.theocc.com/series-search`，交易日當天美東約 20:00 就發布，跨週末差 2.5 天），
GitHub Actions 連得到。改用它之後，未平倉與價格在美東收盤那一刻就同時就緒，
台北早上 09:00 抓正好，比原本的 23:00 早 14 小時。對齊窗口一路開到隔天台北 04:00。
